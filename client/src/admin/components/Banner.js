...
const Banner = () => {
  ...
  const toggleBannerStatus = async (id) => {
    try {
      ...
      setBanners([...banners]);
      toast.success(
        `Banner marked as ${updatedBanner.active ? "Active" : "Inactive"}`
      );
    } catch (error) {
        ...
        <div className="add-banner-form">
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) =>
                setNewBanner({ ...newBanner, caption: e.target.value })
              }
            />
          </div>
        ...
        <div className="existing-banners-section">
          ...
          <div className="banner-grid">
            {banners.map((banner) => (
              <div
                key={banner._id}
                className={`banner-card ${!banner.active ? "inactive" : ""}`}
              >
